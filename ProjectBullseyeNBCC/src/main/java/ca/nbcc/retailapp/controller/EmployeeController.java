...
public class EmployeeController {
	...
	public String toAddEmployee(Model model, @CurrentSecurityContext(expression="authentication?.name")
    String username) throws Exception {
		...
		model.addAttribute("departmentList", dS.getAllDepartmentsFromTheSameStore(currentStore));
		return "add-employee";
	}
