...
public class OrderController {
	...
	public String toOrderDetails(Model model, 
					@PathVariable("oId") Long oId) throws Exception {
		Order orderToDisplay = os.findOrderById(oId);
...
//		}
		...
		model.addAttribute("orderToDisplay", orderToDisplay);
		sendTotalValueToFront(model, orderToDisplay.getOrdDetails());
		return "orderDetails";
	}
